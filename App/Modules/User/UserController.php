...
class UserController extends Controller {
    ...
    /**
     * @OA\Get(tags={"User"}, path="/user/{userId}", summary="Kullanıcı detayı (rolleri ve yetkileri ile)",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer"))
     * )
     */
    public function getById(int $userId): void {
        $result = $this->service->getOne($userId);
        $response = new UserResponse();
        $response->map($result);
    ...
    /**
     * @OA\Delete(tags={"User"}, path="/user/{userId}", summary="Kullanıcı sil (soft delete)",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer"))
     * )
     */
    ...
    /**
     * @OA\Put(tags={"User"}, path="/user/{userId}/role", summary="Kullanıcı rollerini senkronize et",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer")),
     *    @OA\RequestBody(required=true, @OA\JsonContent(
     *       required={"roles"},
     ...
     * )
     */
    public function syncRole(int $userId): void {
        $json = $this->request->json();
        $roles = $json['roles'] ?? [];

        $result = $this->service->syncRole($userId, $roles);
        $response = new UserResponse();
        $response->map($result);
    ...
    /**
     * @OA\Post(tags={"User"}, path="/user/{userId}/role/{roleId}", summary="Kullanıcıya rol ata",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer")),
     ...
     * )
     */
    public function giveRole(int $userId, int $roleId): void {
        $json = $this->request->json();
        $scopeType = $json['scope_type'] ?? null;
        $scopeId = isset($json['scope_id']) ? (int) $json['scope_id'] : null;

        $result = $this->service->giveRole($userId, $roleId, $scopeType, $scopeId);
        $response = new UserResponse();
        $response->map($result);
    ...
    /**
     * @OA\Delete(tags={"User"}, path="/user/{userId}/role/{roleId}", summary="Kullanıcıdan rol kaldır",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer")),
     *    @OA\Parameter(name="roleId", in="path", required=true, @OA\Schema(type="integer"))
     * )
    ...
    public function revokeRole(int $userId, int $roleId): void {
        ...
        $result = $this->service->revokeRole($userId, $roleId, $scopeType, $scopeId);
        $response = new UserResponse();
        $response->map($result);
    ...
    /**
     * @OA\Put(tags={"User"}, path="/user/{userId}/permission", summary="Kullanıcı yetkilerini senkronize et",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer")),
     *    @OA\RequestBody(required=true, @OA\JsonContent(
     ...
     * )
     */
    public function syncPermission(int $userId): void {
        $json = $this->request->json();
        $permissions = $json['permissions'] ?? [];

        $result = $this->service->syncPermission($userId, $permissions);
        $response = new UserResponse();
        $response->map($result);
    ...
    /**
     * @OA\Post(tags={"User"}, path="/user/{userId}/permission/{permissionId}", summary="Kullanıcıya doğrudan yetki ver",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer")),
     ...
     * )
     */
    public function givePermission(int $userId, int $permissionId): void {
        $json = $this->request->json();
        $type = $json['type'] ?? 'allow';
        $scopeType = $json['scope_type'] ?? null;
        $scopeId = isset($json['scope_id']) ? (int) $json['scope_id'] : null;

        $result = $this->service->givePermission($userId, $permissionId, $type, $scopeType, $scopeId);
        $response = new UserResponse();
        $response->map($result);
    ...
    /**
     * @OA\Delete(tags={"User"}, path="/user/{userId}/permission/{permissionId}", summary="Kullanıcıdan doğrudan yetkiyi kaldır",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="userId", in="path", required=true, @OA\Schema(type="integer")),
     *    @OA\Parameter(name="permissionId", in="path", required=true, @OA\Schema(type="integer"))
     * )
     */
    public function revokePermission(int $userId, int $permissionId): void {
        $json = $this->request->json();
        $scopeType = $json['scope_type'] ?? null;
        $scopeId = isset($json['scope_id']) ? (int) $json['scope_id'] : null;

        $result = $this->service->revokePermission($userId, $permissionId, $scopeType, $scopeId);
        $response = new UserResponse();
        $response->map($result);
