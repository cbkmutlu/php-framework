...
class CategoryController extends Controller {
    ...
    /**
     * @OA\Get(tags={"Category"}, path="/category/{categoryId}", summary="Kategori detayı (id'ye göre)",
     *    @OA\Response(response=200, description="Success"),
     ...
     *       @OA\Property(property="translate", type="array", @OA\Items(type="object",
     ...
     *          @OA\Property(property="meta_title", type="string", example="Kategori Meta Başlığı"),
     *          @OA\Property(property="meta_description", type="string", example="Kategori Meta Açıklaması"),
     *          @OA\Property(property="meta_keywords", type="string", example="Kategori Meta Anahtar Kelimeleri")
     *       )),
    ...
    /**
     * @OA\Delete(tags={"Category"}, path="/category/{categoryId}", summary="Kategori sil",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="categoryId", in="path", required=true, @OA\Schema(type="integer"))
     * )
     */
     ...
     *       @OA\Items(required={"id", "sort_order"},
     *          @OA\Property(property="id", type="integer", example=1),
     *          @OA\Property(property="sort_order", type="integer", example=1)
     *       )
     *    ))
    ...
    /**
     * @OA\Delete(tags={"Category"}, path="/category/{categoryId}/image", summary="Kategori resmini sil",
     *    @OA\Response(response=200, description="Success"),
     *    @OA\Parameter(name="categoryId", in="path", required=true, @OA\Schema(type="integer"))
     * )
     */
    public function deleteImage(int $categoryId): void {
        $result = $this->service->deleteImage($categoryId);
